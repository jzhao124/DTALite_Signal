...
extern void OutputMovementMOEData(ofstream &output_MovementMOE_file, int g_SimulationDuration);
...
extern void g_ReadSignalData();
extern void g_ReadSignalTimingStatusFile();
